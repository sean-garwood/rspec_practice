...
describe NumberGame do
  ...
  describe '#initialize' do
    context 'when solution is initialized' do
      ...
      matcher :be_between_zero_and_nine do
        match { |solution| (0..9).include?(solution) }
      end
  ...
  describe '#game_over?' do
    ...
    subject(:game_continue) { described_class.new(6, '9') }
  ...
  describe '#verify_input' do
    ...
    subject(:game_invalid_input) { described_class.new(0, '10') }
    context 'when given invalid input as argument' do
      it 'returns nil' do
        invalid = '10'
        unverified_input = game_check.verify_input(invalid)
        expect(unverified_input).to be_nil
      end
    end
  end
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        bad2 = 'y'
        goot = '1'
        allow(game_loop).to receive(:player_input).and_return(bad1, bad2, goot)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      subject(:game_three) { described_class.new(9, '9', 3) }
      it 'outputs correct phrase' do
    ...
    context 'when count is 4 and over' do
      subject(:horrible_game) { described_class.new(9, '9', 9) }
      it 'outputs correct phrase' do
        fail_phrase = "That was hard. It took you #{horrible_game.count} guesses!\n"
        expect { horrible_game.final_message }.to output(fail_phrase).to_stdout
      end
    end
  end
end
